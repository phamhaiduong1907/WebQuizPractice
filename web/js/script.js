...
//function registrationPagging(id, pageindex, totalpage, gap, sortBy, orderBy, target)
//{
//    var container = document.getElementById(id);
//    var result = '';
//    if (pageindex - gap > 1) {
//        result += '<a href="registration' + target + '?sortBy=' + sortBy + '&orderBy=' + orderBy + '&page=1">' + 'First' + '</a>';
//    }
//    for (var i = pageindex - gap; i < pageindex; i++)
//        if (i > 0)
//            result += '<a href="registration' + target + '?sortBy=' + sortBy + '&orderBy=' + orderBy + '&page=' + i + '">' + i + '</a>';
//
//    result += '<span>' + pageindex + '</span>';
//
//    for (var i = pageindex + 1; i <= pageindex + gap; i++)
...
//
//    if (pageindex + gap < totalpage) {
//        result += '<a href="registration' + target + '?sortBy=' + sortBy + '&orderBy=' + orderBy + '&page=' + totalpage + '">' + 'Last' + '</a>';
//    }
//    container.innerHTML = result;
//}
