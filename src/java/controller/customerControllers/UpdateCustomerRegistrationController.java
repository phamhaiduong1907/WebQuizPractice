 ...
 * @author ADMIN
 */
public class UpdateCustomerRegistrationController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (registrationDBContext.updateRegistration(pricePackageID, account.getUsername(), registrationID)) {
